...
}, getUserWithProfile = (userId) => prisma.user.findUnique({
  where: { id: userId },
  include: { profile: !0 }
}), getUserALl = async (userId) => prisma.user.findUnique({
  where: { id: userId },
  include: {
    profile: {
      include: {
...
}, getProfileWithAll = (profileId) => prisma.profile.findUnique({
  where: { id: profileId },
  include: {
    user: !0,
    experience: !0,
...
// app/routes/dashboard/__dashboard/experience/edit/$experienceId.tsx
var import_react8 = require("@remix-run/react"), import_date_fns = require("date-fns"), import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader3 = async ({ request, params }) => {
...
}, getEducationById = async (expId) => await prisma.education.findUnique({
  where: { id: expId }
});
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), action = async ({ request }) => {
  ...
  return errors ? (0, import_node6.json)({ errors }) : (0, import_node6.redirect)("/dashboard");
};
...
var import_react12 = require("react"), import_node7 = require("@remix-run/node"), import_react13 = require("@remix-run/react");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), action2 = async ({ request }) => {
  let fieldNames = ["title", "company", "location", "from", "to", "current", "description"], fieldsToValidate = ["title", "company", "from"], dateFields = ["from", "to"], errorMessages = {
    title: "Job Title is required",
    company: "Company is required",
    from: "From date is required"
  }, { errors, data } = await processFormData(
    request,
    fieldNames,
    errorMessages,
    fieldsToValidate,
  ...
  if (!data.current && !data.to && (errors || (errors = {}), errors.to = "To date is required"), errors)
    return (0, import_node7.json)({ errors });
  let experience = await createExperience(request, data);
  return (0, import_node7.redirect)("/dashboard/experiences");
};
...
var import_react14 = require("react"), import_react15 = require("@remix-run/react"), import_node8 = require("@remix-run/node");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), action3 = async ({ request }) => {
  let fieldNames = ["school", "degree", "fieldofstudy", "from", "to", "current", "description"], fieldsToValidate = ["school", "degree", "from"], dateFields = ["from", "to"], errorMessages = {
  ...
  return (0, import_node8.redirect)("/dashboard/educations");
};
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader5 = async ({ request }) => await isAuthenticated(request) ? (0, import_node9.json)({ profile: await getProfile(request) }) : (0, import_node9.redirect)("/");
...
var import_react17 = require("@remix-run/react"), import_node10 = require("@remix-run/node"), import_date_fns3 = require("date-fns");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader6 = async ({ request }) => await isAuthenticated(request) ? { experience: await getExperience(request) } : (0, import_node10.redirect)("/");
...
var import_react18 = require("@remix-run/react"), import_node11 = require("@remix-run/node"), import_date_fns4 = require("date-fns");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader7 = async ({ request }) => await isAuthenticated(request) ? { education: await getEducation(request) } : (0, import_node11.redirect)("/");
...
var import_node12 = require("@remix-run/node"), import_react_fontawesome = require("@fortawesome/react-fontawesome"), import_free_brands_svg_icons = require("@fortawesome/free-brands-svg-icons"), import_free_solid_svg_icons = require("@fortawesome/free-solid-svg-icons"), import_react19 = require("@remix-run/react");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader8 = async ({ request }) => {
  let userId = await authenticatedUser(request);
  if (!userId)
    return (0, import_node12.redirect)("/");
  let user = await getUserWithProfile(userId);
  return (0, import_node12.json)({ user });
};
function ProfileShow() {
  let { user } = (0, import_react19.useLoaderData)();
  return user.profile ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
                          ...
                          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", {
                                ...
                                children: "Dolor sit amet consectetur adipisicing elit. Reprehenderit, eligendi dolorum sequi illum qui unde aspernatur non deserunt"
                              }, void 0, !1, {
                                fileName: "app/routes/dashboard/__dashboard/profile.tsx",
                                lineNumber: 134,
                                columnNumber: 31
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
                            className: "text-teal-600 font-semibold",
                            children: "Masters Degree in Computer Science"
                          }, void 0, !1, {
                            fileName: "app/routes/dashboard/__dashboard/profile.tsx",
                            lineNumber: 171,
                            columnNumber: 28
...
var import_react20 = require("@remix-run/react"), import_node13 = require("@remix-run/node"), import_date_fns5 = require("date-fns"), import_react_fontawesome2 = require("@fortawesome/react-fontawesome"), import_free_solid_svg_icons2 = require("@fortawesome/free-solid-svg-icons");
                        ...
                        children: experience && experience.length > 0 ? experience.map((exp, expIndex) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tr", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("td", {
                              className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500",
                              children: [
                                (0, import_date_fns5.format)(new Date(exp.from), "MM/dd/yyyy"),
                                " - ",
                                " ",
                                exp.to ? (0, import_date_fns5.format)(new Date(exp.to), "MM/dd/yyyy") : "Present"
                              ]
                            }, void 0, !0, {
                              fileName: "app/routes/dashboard/__dashboard/index.tsx",
                              lineNumber: 86,
                        ...
                        children: education && education.length > 0 ? education.map((edu, eduIndex) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tr", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("td", {
                              className: "whitespace-nowrap px-3 py-4 text-sm text-gray-500",
                              children: [
                                (0, import_date_fns5.format)(new Date(edu.from), "MM/dd/yyyy"),
                                " - ",
                                " ",
                                edu.to ? (0, import_date_fns5.format)(new Date(edu.to), "MM/dd/yyyy") : "Present"
                              ]
                            }, void 0, !0, {
                              fileName: "app/routes/dashboard/__dashboard/index.tsx",
                              lineNumber: 133,
...
var import_node14 = require("@remix-run/node"), import_react21 = require("@remix-run/react"), import_date_fns6 = require("date-fns"), import_react_fontawesome3 = require("@fortawesome/react-fontawesome"), import_free_solid_svg_icons3 = require("@fortawesome/free-solid-svg-icons"), import_free_brands_svg_icons2 = require("@fortawesome/free-brands-svg-icons");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader10 = async ({ request, params }) => {
  let profileId = params.profileId, profile = await getProfileWithAll(profileId);
  return (0, import_node14.json)({ profile });
};
function ProfileShow2() {
  let { profile } = (0, import_react21.useLoaderData)(), renderExperience = (exp) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    className: "list-inside space-y-1 mb-4",
    children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        className: "text-teal-600 font-semibold",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", {
            ...
            children: [
              (0, import_date_fns6.format)(new Date(exp.from), "MMMM yyyy"),
              " - ",
              exp.to === null ? "Present" : (0, import_date_fns6.format)(new Date(exp.to), "MMMM yyyy")
            ]
          }, void 0, !0, {
            fileName: "app/routes/profiles/$profileId.tsx",
            lineNumber: 27,
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
        className: "text-gray-700 text-sm",
        children: [
          (0, import_date_fns6.format)(new Date(edu.from), "MM/dd/yy"),
          " - ",
          edu.to === null ? "Present" : (0, import_date_fns6.format)(new Date(edu.to), "MM/dd/yy")
        ]
      }, void 0, !0, {
        fileName: "app/routes/profiles/$profileId.tsx",
        lineNumber: 51,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("li", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", {
                          className: "ml-auto",
                          children: (0, import_date_fns6.format)(new Date(profile.user.date), "MMM dd, yyyy")
                        }, void 0, !1, {
                          fileName: "app/routes/profiles/$profileId.tsx",
                          lineNumber: 104,
                          columnNumber: 28
...
var import_react22 = require("@remix-run/react"), import_node15 = require("@remix-run/node");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader11 = async ({ request }) => await isAuthenticated(request) ? (0, import_node15.redirect)("/dashboard") : null, action4 = async ({ request }) => {
  ...
  if (password !== password2)
    return (0, import_node15.json)({ errors: { password2: "Password does not match!" } });
...
var import_outline2 = require("@heroicons/react/outline"), import_node16 = require("@remix-run/node"), import_react23 = require("@remix-run/react");
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader12 = async () => {
  let profiles = await getProfiles();
  return (0, import_node16.json)({ profiles });
};
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react23.Link, {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", {
                      src: "https://avatars0.githubusercontent.com/u/130138?s=460&v=4",
                      alt: "Avatar",
...
var action5 = async ({ request }) => (0, import_node17.redirect)("/", {
  headers: {
...
var import_react24 = require("@remix-run/react"), import_node18 = require("@remix-run/node");
...
// app/routes/posts/$postId.tsx
var import_moment = __toESM(require("moment")), import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader13 = async ({ request, params }) => {
  ...
  if (!userId)
    return (0, import_node18.json)({ errors: { post: "You must login or register to create a post" } });
  let text = (await request.formData()).get("text");
  return !text || text.toString().length < 6 ? (0, import_node18.json)({ errors: { post: "Post must be at least 6 characters" } }) : (await createComment(userId, postId, text.toString()), (0, import_node18.redirect)(`/posts/${postId}`));
};
function Post() {
  var _a;
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader14 = async ({ request }) => {
  let session = await getSession(request);
  if (session.has("token"))
    return (0, import_node19.redirect)("/dashboard");
  ...
  return userId === null ? (session.flash("error", "Invalid username or password"), (0, import_node19.redirect)("/login", {
    headers: { "Set-Cookie": await sessionStorage.commitSession(session) }
...
var action8 = async ({ request }) => {
  ...
  if (!postId)
    return (0, import_node20.redirect)("/posts");
  try {
